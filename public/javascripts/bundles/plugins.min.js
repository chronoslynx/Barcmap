$(document).ready(function(){var tabs=$('ul.tabs'),tabsContent=$('ul.tabs-content');tabs.each(function(i){var tab=$(this).find('> li > a');tab.click(function(e){var contentLocation=$(this).attr('href')+"Tab";if(contentLocation.charAt(0)=="#"){e.preventDefault();tab.removeClass('active');$(this).addClass('active');$(contentLocation).show().siblings().hide();}});});});
...
(function(){window.onload=function(){return jQuery(function($){var can,circle,circle2,map;can=Raphael(document.getElementById("map",700,400));map=can.image("/images/map.jpg",0,0,700,400);circle=can.circle(50,40,20);circle.attr("fill","#000");circle2=can.circle(100,200,40);circle2.attr("fill","#fb3");circle.node.onclick=function(e){return $.fancybox({'href':'/locations/1','width':'400px','height':'400px','autoScale':false,'type':'ajax','transitionIn':'fade','transitionOut':'fade'});};return circle2.node.onclick=function(e){return $.fancybox({'href':'/locations/2','width':'400px','height':'400px','autoScale':false,'type':'ajax','transitionIn':'fade','transitionOut':'fade'});};});};}).call(this);
